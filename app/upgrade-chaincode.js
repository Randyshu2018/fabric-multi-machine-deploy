...
var upgradeChaincode = function (req, res) {
    ...
    return helper.getOrgAdmin(org).then((user) => {
        ...
        return channel.sendUpgradeProposal(request, config.eventWaitTime);
    }, (err) => {
        ...
        logger.error('Failed to send upgrade due to error: ' + err.stack ? err
            .stack : err);
        return res.json('Failed to send upgrade due to error: ' + err.stack);
    });
};
